...
def estimate_BLP(df, alphas, sigma_alpha_init, mode, verbose_print = 1, scale_delta_guess=1, delta_solve_init=False, beta_true = (5, 1, 1), gamma_true = (2, 1, 1), alpha_true=1, sigma_alpha_true=1):
